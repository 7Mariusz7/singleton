...
public class ReportBuilder {
	...
	// Class variables
	// Single instance
	private volatile static ReportBuilder instance; //Zmiana +volatile
	...
	private ReportBuilder() { //Zmiana ->private
		initiatlize();
	}
	 ...
	 */
	public static synchronized ReportBuilder getinstance() { //zmiana +synchronized
